...
class CloudMeadowSaveEditor:
    ...
    def create_widgets(self):
        ...
        self.save_folder_button = tk.Button(self.master, text="Save Folder", command=self.open_save_folder, width=12)
        self.save_folder_button.grid(row=0, column=1, padx=10, pady=10)

        self.restore_backup_button = tk.Button(self.master, text="Restore Backup", command=self.restore_backup, width=15, state="disabled")
